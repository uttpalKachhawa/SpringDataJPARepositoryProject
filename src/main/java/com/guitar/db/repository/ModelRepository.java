...
public class ModelRepository {
	...
	/*	mod = entityManager.merge(mod);
		entityManager.flush();*/
		Model model=modelJpaRepository.saveAndFlush(mod);
		return model;
	}
	...
	/*	@SuppressWarnings("unchecked")
		...
		return mods;*/
		return modelJpaRepository.findByPriceGreaterThanEqualsAndPriceLessThanEquals(lowest, highest);
	}
	 ...
	 * Custom finder
	 */
	public Page<Model> getModelsByPriceRangeAndWoodTypes(BigDecimal lowest, BigDecimal highest, String wood) {
		@SuppressWarnings("unchecked")
		Sort sort = new Sort(Sort.Direction.ASC,"name");
		Pageable page=new PageRequest(0, 2);
		
		return modelJpaRepository.queryByPriceRangeAndWoodTypes(lowest, highest, "%" + wood + "%",page);
	...
	public List<Model> getModelsByType(String modelType) {
		@SuppressWarnings("unchecked")
		List<Model> mods = modelJpaRepository.findAllModelsByType(modelType);
		/*entityManager
